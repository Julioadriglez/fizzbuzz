...
app.get("/v1/explorers/fizzbuzz/:number", (req, res) => {
    const number = req.params.number;
    const fizzbuzz= ExplorerController.gettApplyValidationInNumber(number);
    res.json({score:req.params.number, trick:fizzbuzz});
});
